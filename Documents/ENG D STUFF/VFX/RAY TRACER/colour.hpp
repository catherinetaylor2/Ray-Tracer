...
class TriangleColour{
    public:
       ...
       static vector3 intersection_colour(vector3 direction, vector3 camera_origin, std::vector<search_tree*> root_data,  std::vector<float*> mesh_data, std::vector<int*> mesh_data_i, const int* tri_colour, Light sun, scene myscene, std::vector<unsigned char*> data_bmp, int* texture_data, int pixel_x,int pixel_y);
